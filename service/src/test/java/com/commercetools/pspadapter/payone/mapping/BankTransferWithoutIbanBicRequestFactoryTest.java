...
public class BankTransferWithoutIbanBicRequestFactoryTest extends BaseTenantPropertyTest {
    ...
    public void createFullAuthorizationRequestFromValidPayment_iDeal() throws Exception {
        ...
        //base values
        softly.assertThat(result.getOnlinebanktransfertype()).isEqualTo(ClearingType.PAYONE_IDL.getSubType());
        ...
        //clearing type
        ClearingType clearingType = ClearingType.getClearingTypeByKey("BANK_TRANSFER-IDEAL");
