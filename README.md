...
`PERSONAL_DATA_TO_REMOVE`             | No  | if provided and not empty, the provided values will be removed from logs | "" (empty String). Fields should be split by `,` OR `;` and should not contain whitespaces (they will be trimmed)
