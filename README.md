...
`CT_AUTH_URL`                         | Yes                | if set, this value will be used for authentication by the sphere client.                                                                                                                                                                                                                                                                                                                                                                                                   | "https://auth.europe-west1.gcp.commercetools.com"
`CT_API_URL`                          | Yes                | if set, this value will be used as the API endpoint by the sphere client.                                                                                                                                                                                                                                                                                                                                                                                                  | "https://api.europe-west1.gcp.commercetools.com"
